...
// IncrementalRefreshTradeSummaryOrderIdGroupIterator
struct IncrementalRefreshTradeSummaryOrderIdGroupIterator {
    ...
    void initialize(const std::byte* data) {
        ...
        block_length = group_size_8_byte->block_length.get();
